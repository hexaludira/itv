...
if (isset($_POST["id_prod_header"])){
  ...
  //======================= Mengupdate pro Detail dari Modal Edit (UPDATE) =======================//
    ...
    $sql_update = "UPDATE itv_prod_detail_rm SET quantity = '$quantity', id_item = '$id_item', lastupdateddatetime = '$lastupdateddatetime', lastupdatedby = '$lastupdatedby' WHERE id_prod_detail_rm = $id_prod_detail_rm";
