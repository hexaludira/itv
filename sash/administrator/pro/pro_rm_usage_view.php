        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><a class='h10'>Active menu/<b>PRODUCTION/Production Order/Material Consumption Detail</b></a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Data Production Order & Material Consumption Detail</h3>
            </div>
                <div class="card-body">
                <form method="POST">
                ...
                <div class="form-group">
                  ...
                  <div class="col-12">
                      <div class="card"> 
                        <div class="card-header">
                            <h3 class="card-title">Data Material Consumption Detail</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#modal_add_pro_rm_detail"><i class="fas fa-plus-square"></i> Add</button>
                            </div>
              </div>                     
                        <div class="card-body">                      
                          <table id="example2" class="table table-bordered table-striped" cellspacing="0">
                            ...
                            <tr>
                              ...
                              <td>
                                <?php $status = $data['status'];?>
                                <?php if($status == "10"){?>
                                <button class="btn btn-default btn-sm btn_edit" id="<?php echo $data['id_prod_detail_rm']; ?>"><i class="fas fa-code-fork"></i>
                                    Consumption
                                </button>
                                <button class="btn btn-default btn-sm btn_delete" id="<?php echo $data['id_prod_detail_rm']; ?>"><i class="fas fa-trash-can"></i>
                                    Delete
                                </button>
                                <?php }elseif($status == "50"){ ?> 
                                <button class="btn btn-default btn-sm btn_edit" id="<?php echo $data['id_prod_detail_rm']; ?>" disabled><i class="fas fa-code-fork"></i>
                                  Consumption
                                </button>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Add Material Consumption Detail</h4>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <label><h5>Consumption Quantity</h5></label>
...
<div class="modal fade" id="pro_rm_detail_edit_modal">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-body">
				  ...
				  <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            <button type="button" class="btn btn-success" id="btn_pro_rm_detail_update">Save</button>
				</div>
			</div>
		</div>
	</div>
  ...
  <div class="modal fade" id="pro_rm_delete_modal" tabindex="-1">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Delete Material Order & Consumption Detail</h4>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
  ...
  $($.fn.dataTable.tables(true)).DataTable()
         ...
         .responsive.recalc();
          ...
          $(document).ready(function(){
            ...
            $.ajax({
              url : "sash/administrator/pro/pro_rm_usage_controller.php",
              type : "POST",
              data : {
        ...
        let batch = $('#batch_edit').val();
				...
				$.ajax({
					...
					success : function(response){
						console.log(response);
            if(response == "1"){
              Swal.fire("Data updated consumption succesfully",'','success');
            } else {
              Swal.fire("Update consumption data failed",'','error');
            }
