                      ...
                      <div class="card"> 
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#modal_add_bom_detail"><i class="fas fa-plus-square"></i> Add</button>
                            </div>
              </div>                     
                        <div class="card-body">                      
                          <table id="example2" class="table table-bordered table-striped" cellspacing="0">
                            ...
                            <tr>
                              ...
                              <td>                                
                                <button class="btn btn-default btn-sm btn_edit" id="<?php echo $data['id_bom_detail']; ?>"><i class="fas fa-pencil-alt"></i>
                                    Edit
                                </button>
                                <button class="btn btn-default btn-sm btn_delete" id="<?php echo $data['id_bom_detail']; ?>"><i class="fas fa-trash-can"></i>
                                    Delete
                                </button>                                
                            </td>               
                            </tr>  
