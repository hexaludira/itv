                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        <?php $status = $data['status'];?>
                        <?php if($status == "10"){?>
                        <a class="btn btn-default btn-sm" href="?page=bom_detail_view&kode=<?php echo $data['id_bom_header']; ?>"><i class="fas fa-sitemap"></i>
                            Material
                        </a>
                        <button class="btn btn-success btn-sm btn_activate" id="<?php echo $data['id_bom_header']; ?>"><i class="fas fa-check"></i>
                            Activate
                        </button>                       
                        <button class="btn btn-info btn-sm btn_edit" id="<?php echo $data['id_bom_header']; ?>"><i class="fas fa-pencil-alt"></i>
                            Edit
                        </button>
                        <button class="btn btn-danger btn-sm btn_delete" id="<?php echo $data['id_bom_header']; ?>"><i class="fas fa-trash-can"></i>
                            Delete
                        </button>
                        <?php }elseif($status == "60"){ ?>
                        <a class="btn btn-default btn-sm" href="?page=bom_detail_blocked_view&kode=<?php echo $data['id_bom_header']; ?>"><i class="fas fa-sitemap"></i>
                            Material
                        </a>
                        <button class="btn btn-secondary btn-sm btn_deactivate" id="<?php echo $data['id_bom_header']; ?>"><i class="fas fa-ban"></i>
                            Deactivate
                        </button>                       
