<?php
 ...
 //===================== Insert Detail =======================//
if (isset($_POST["id_scrap_header"])){
 
    $id_scrap_header =  $_POST["id_scrap_header"];
    ...
    $sql2 = "INSERT INTO itv_scrap_detail (id_scrap_header,id_item,quantity,batch,createddatetime,createdby,isdelete,status)                                                                     
                            VALUES (
                                '$id_scrap_header',
                                '$id_item',
                                '$quantity',
    ...
    else if(isset($_POST["id_scrap_detail_edit"])){
    $id_scrap_detail = $_POST["id_scrap_detail_edit"];
    $sql = $koneksi->query("SELECT * FROM itv_scrap_detail WHERE id_scrap_detail = $id_scrap_detail");
  ...
  //======================= Mengupdate dari Modal Edit (UPDATE) =======================//
    else if (isset($_POST["id_scrap_detail_update"])){
    $id_scrap_detail = $_POST["id_scrap_detail_update"];
    ...
    $sql_update = "UPDATE itv_scrap_detail SET quantity = '$quantity', batch = '$batch', id_item = '$id_item', lastupdateddatetime = '$lastupdateddatetime', lastupdatedby = '$lastupdatedby' WHERE id_scrap_detail = $id_scrap_detail";
  ...
  //============================== Delete Detail ======================================//
    else if(isset($_POST["id_scrap_detail_delete"])){
    $id_scrap_detail = $_POST["id_scrap_detail_delete"];
    $lastupdateddatetime = date('Y-m-d H:i:s');
    $lastupdatedby = $data_nama;

    $sql_delete = "UPDATE itv_scrap_detail SET isdelete = '2', lastupdateddatetime = '$lastupdateddatetime', lastupdatedby = '$lastupdatedby' WHERE id_scrap_detail = $id_scrap_detail";
