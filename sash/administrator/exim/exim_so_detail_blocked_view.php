        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><a class='h10'>Active menu/<b>EXIM/Sales Order/Sales Order Detail</b></a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="card card-primary">
            <div class="card-header">
                  ...
                  <div class="row">  
                    <div class="col-md-1">
                      ...
                      <div class="col-md-4">  
                        ...
                        <textarea class="form-control" rows="1" placeholder="Customer Name" id="Name" name="Name" disabled><?php echo $data_cek['bp_name']; ?></textarea>
                      </div>                     
                    </div>          
                  </div>                 
                  </br>
                      ...
                      <div class="card"> 
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#modal_add_so_detail" disabled><i class="fas fa-plus-square"></i> Add</button>
                            </div>
              </div>                     
                        <div class="card-body">                      
                          <table id="example2" class="table table-bordered table-striped" cellspacing="0">
                            ...
                            <?php              
                              ...
                              $sql = $koneksi->query("SELECT
                                                    ...
                                                    LEFT JOIN itv_wh_header as e ON a.id_so_header = e.id_order_header 
                                                    LEFT JOIN itv_wh_detail as f ON e.id_wh_header = f.id_wh_header AND f.id_order_detail = a.id_so_detail
                                                    LEFT JOIN itv_wh_detail_root as g ON f.id_wh_detail = g.id_wh_detail
                                                    WHERE a.id_so_header='" . $_GET['kode'] . "' AND a.isdelete='1' AND e.id_trx_type_code = '31' AND e.id_order_type = '130' AND g.isdelete = '1'
                                                    ORDER BY a.id_so_detail ASC");
              ...
              <div class="modal-footer justify-content-between">
                <a class="btn btn-secondary" href="?page=exim_so_view"><i class="fas fa-backward"></i> Back</a>
              </div>
            </form>
                </div>
          </div>
