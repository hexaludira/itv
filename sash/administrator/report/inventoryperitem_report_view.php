...
// var_dump($_SESSION);
$itemcode = isset($_POST['report_item_code']) ? $_POST['report_item_code'] : '';
$printby = isset($_SESSION['ses_nama']) ? $_SESSION['ses_nama'] : '';

$reportPath = "/flow.html?_flowId=viewReportFlow&standAlone=true&_flowId=viewReportFlow&ParentFolderUri=%2Freports&reportUnit=%2Freports%2FInventoryperitem&j_username=free&j_password=free&Item_Code=$itemcode&printby=$printby";
...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Report - Inventory per Item</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><a class='h10'>Active menu / <b>REPORT / Inventory per Item</b></a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
             ...
             <div class="card-body">
                ...
                <form method="POST" action="">															 
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <input type="text" id="report_item_code" name="report_item_code" class="form-control">
                            </div>
                        </div>
