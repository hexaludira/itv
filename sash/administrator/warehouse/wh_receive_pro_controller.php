<?php
 ...
 if (isset($_SESSION['ses_nama']) == "") {
  ...
  //======================= Receive dari Modal Edit (UPDATE) =======================//
    ...
    $sql_update_trigger2 = "UPDATE itv_prod_header SET status = '70', lastupdateddatetime = '$lastupdateddatetime', lastupdatedby = '$lastupdatedby' WHERE id_prod_header = $id_order_header";
    $query_update_trigger2 = mysqli_query($koneksi, $sql_update_trigger2); 

    $sql_update_trigger3 = "UPDATE itv_wh_header SET status = '40', lastupdateddatetime = '$lastupdateddatetime', lastupdatedby = '$lastupdatedby' WHERE id_wh_header = $id_wh_header";
    $query_update_trigger3 = mysqli_query($koneksi, $sql_update_trigger3); 

    $sql_update_trigger4 = "UPDATE itv_prod_detail_fg SET status = '40', lastupdateddatetime = '$lastupdateddatetime', lastupdatedby = '$lastupdatedby' WHERE id_prod_detail_fg = $id_order_detail AND id_prod_header = $id_order_header";
    $query_update_trigger4 = mysqli_query($koneksi, $sql_update_trigger4);

    $sql_update_trigger4 = "UPDATE itv_wh_detail_root SET actual_quantity = '$actual_quantity', datetime = '$receive_datetime', batch = '$batch', status = '40', lastupdateddatetime = '$lastupdateddatetime', lastupdatedby = '$lastupdatedby' WHERE id_wh_detail = $id_wh_detail AND id_wh_detail_root = $id_wh_detail_root";
    $query_update_trigger4 = mysqli_query($koneksi, $sql_update_trigger4);
  ...
  //================= <END> Receive user dari Modal Edit (UPDATE) <END> =================//
