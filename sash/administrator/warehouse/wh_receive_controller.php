<?php
 ...
 if (isset($_SESSION['ses_nama']) == "") {
  ...
  //======================= Receive dari Modal Edit (UPDATE) =======================//
    ...
    $sql_update_trigger2 = "UPDATE itv_po_header SET status = '40', lastupdateddatetime = '$lastupdateddatetime', lastupdatedby = '$lastupdatedby' WHERE id_po_header = $id_order_header";
    ...
    $sql_update_trigger4 = "UPDATE itv_po_detail SET status = '40', lastupdateddatetime = '$lastupdateddatetime', lastupdatedby = '$lastupdatedby' WHERE id_po_detail = $id_order_detail AND id_po_header = $id_order_header";
