                          ...
                          <table id="example2" class="table table-bordered table-striped" cellspacing="0">
                            ...
                            <tr>
                              ...
                              <td>
                                <?php $status = $data['status'];?>
                                <?php if($status == "10"){?>
                                  <button class="btn btn-warning btn-sm btn_edit" id="<?php echo $data['id_wh_detail']; ?>" name="<?php echo $data['id_wh_detail_root']; ?>"><i class="fas fa-dolly-flatbed"></i></button>
...
<script type="text/javascript">
  ...
  $($.fn.dataTable.tables(true)).DataTable()
      ...
      $('#example2').on('click','.btn_edit', function(e){
        ...
        $.ajax({
          url : "sash/administrator/warehouse/wh_deliver_controller.php",
          type : 'POST',
