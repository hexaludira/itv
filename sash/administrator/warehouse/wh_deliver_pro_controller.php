<?php
 ...
 if (isset($_SESSION['ses_nama']) == "") {
  ...
  //======================= Deliver dari Modal Edit (UPDATE) =======================//
    ...
    $sql_update_trigger2 = "UPDATE itv_prod_header SET status = '60', lastupdateddatetime = '$lastupdateddatetime', lastupdatedby = '$lastupdatedby' WHERE id_prod_header = $id_order_header";
    ...
    $sql_update_trigger4 = "UPDATE itv_prod_detail_rm SET status = '50', lastupdateddatetime = '$lastupdateddatetime', lastupdatedby = '$lastupdatedby' WHERE id_prod_detail_rm = $id_order_detail AND id_prod_header = $id_order_header";
