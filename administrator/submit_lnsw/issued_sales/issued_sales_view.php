        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><a class='h10'>IT Inventory Active menu - <b>Submit To LNSW>Issued To Sales</b></a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">  
                ...
                <div class="tab-content" id="custom-tabs-three-tabContent">
                  ...
                  <div class="col-12">
                      <div class="card">
                        <div class="card-header">
                          <h3 class="card-title">Issued To Sales Data</h3>
                        </div>
                          <div class="card-body">
                            <table id="example2" class="table table-bordered table-striped" cellspacing="0">
                              ...
                              <tbody>
                                <?php                     
                                  $sql = "																								
                                          SELECT
                                          B.LastUpdatedDateTime as LastUpdatedDateTime,
                                          B.Werks as Werks,
                                          B.DeliveryNoticeNo as DeliveryNoticeNo,
                                          B.DeliveryNoticeItemNo as DeliveryNoticeItemNo,
                                          B.VGPOS as SalesOrderItemNo,
                                          B.VGBEL as SalesOrderNo,
                                          B.Matnr as Matnr,
                                          C.Name as Name,
                                          B.DeliveredQuantity as Quantity,
                                          B.Unit as Unit
                                          FROM
                                          DeliveryNoticeItem as B
                                          INNER JOIN DeliveryNotice as A on A.DeliveryNoticeNo=B.DeliveryNoticeNo
                                          INNER JOIN Material as C on B.Matnr=C.Matnr AND b.Werks=c.Werks
                                          WHERE 
                                          B.CreatedDateTime > '2023-12-31 00:00:00'
                                          AND
                                          A.IsDelete = 0
                                          AND
                                          B.IsDelete = 0
                                          AND
                                          C.IsDelete = 0																
                                          ORDER BY LastUpdatedDateTime,Werks,DeliveryNoticeNo,DeliveryNoticeItemNo,SalesOrderNo																																															
																					";
                                ...
                                ?>
                                  <tr> 
                                    <td>
                                      <?php 
                                        $newformatdate = $data['LastUpdatedDateTime']->format('Y-m-d H:i:s');
                                        echo $newformatdate; 
                                      ?>
                                    </td>  
                                    <td><?php echo $data['DeliveryNoticeNo']; ?></td>  
                                    <td><?php echo $data['DeliveryNoticeItemNo']; ?></td>      
                                    <td><?php echo $data['Werks']; ?></td>                                        
                                    <td><a href="?page=so_edit_blocked&kode=<?php echo $data['SalesOrderNo']; ?>"><u><?php echo $data['SalesOrderNo']; ?></u></a></td>                                                          
                                    ...
                                    <td style="text-align:center;">
                                      <?php 
                                        $sql2 = $koneksi->query("SELECT IFNULL( (SELECT DISTINCT A.price
                                                                 ...
                                                                 WHERE A.SalesOrderNo='$data[SalesOrderNo]' AND A.Werks='" . $data['Werks'] . "' AND A.SalesOrderItemNo='$data[SalesOrderItemNo]' AND A.isdelete='1'),'1')");                                                                                  
                                    ...
                                    <td>
                                      <?php 
                                        $sql2 = $koneksi->query("SELECT B.nomorDokumen as dokumen, 
                                                                 ...
                                                                 WHERE A.SalesOrderNo='$data[SalesOrderNo]' AND A.SalesOrderItemNo='" . $data['SalesOrderItemNo'] . "' AND A.Matnr='" . $data['Matnr'] . "' AND A.Werks='" . $data['Werks'] . "' AND A.isdelete='1'");
                                    ...
                                    <td>
                                      <?php 
                                        $sql2 = $koneksi->query("SELECT IFNULL( (SELECT A.price
                                                                 ...
                                                                 WHERE A.SalesOrderNo='$data[SalesOrderNo]' AND A.SalesOrderItemNo='" . $data['SalesOrderItemNo'] . "' AND A.Matnr='" . $data['Matnr'] . "' AND A.Werks='" . $data['Werks'] . "' AND A.isdelete='1'),'1')");                                   
                                        while ($data2= $sql2->fetch_row()) {   
                                        $row_cnt = $data2[0];                                                                                                            
                                        if ($row_cnt == '1') 
                                        { ?>
                                          <button class="btn btn-warning btn-sm btn_edit" name="<?php echo $data['SalesOrderNo']; ?>" id="<?php echo $data['SalesOrderItemNo']; ?>" disabled><i class="fa fa-atom fa-spin"></i>
                                            Transform
                                          </button>
                                            <?php
                                        }
                                        ...
                                        { 
                                            ?> 
                                          <button class="btn btn-warning btn-sm btn_edit" name="<?php echo $data['SalesOrderNo']; ?>" id="<?php echo $data['DeliveryNoticeNo']; ?>"><i class="fa fa-atom fa-spin"></i>
                                            Transform
                                          </button>
                                            <?php
                                        }
                  ...
                  <div class="col-12">
                      <div class="card">
                        <div class="card-header">
                          <h3 class="card-title">Issued To Sales Transformed Data</h3>
                        </div>
                          <div class="card-body">                          
                          ...
                          <?php                     
                            ...
                            A.DeliveryNoticeNo as DeliveryNoticeNo,
                            A.DeliveryNoticeNo_CreatedDateTime as DeliveryNoticeNo_CreatedDateTime,
                            ...
                            AND
                            A.submit_status = '1'
                            ORDER BY A.Werks,A.SalesOrderNo,A.DeliveryNoticeNo,A.DeliveryNoticeNo_CreatedDateTime");
                            while ($data= $sql->fetch_assoc()) {
                          ?>         
                            <tr>   
                            <td><?php echo $data['SalesOrderNo']; ?></td>
                            <td><?php echo $data['DeliveryNoticeNo']; ?></td> 
                            <td><?php echo $data['DeliveryNoticeNo_CreatedDateTime']; ?></td> 
                            ...
                            <td><button class="btn btn-primary btn-sm btn_submit" name="<?php echo $data['SalesOrderNo']; ?>" id="<?php echo $data['DeliveryNoticeNo']; ?>" onclick="return confirm('Do you really want to submit ?')"><i class="fa fa-paper-plane"></i>
                                  Submit
                                </button>
                            </td> 
                            </tr> 
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <div class="form-group">                                                       
                            <input type="hidden" class="form-control" id="flag_issue_type" name="flag_issue_type" value="1">                         
                          </div>
                          <div class="form-group">                                                       
                            <input type="hidden" class="form-control" id="id_trx_type_code" name="id_trx_type_code" value="31">                         
                          </div>  
                          <div class="form-group">                           
                          ...
                          <div class="form-group"> 
                            <label><h5>Shipment No</h5></label>                             
                            <input type="text" class="form-control" id="DeliveryNoticeNo" name="DeliveryNoticeNo" disabled>                         
                          </div> 
                          <div class="form-group"> 
                            <label><h5>Issued Date Time</h5></label>                             
                            <input type="text" class="form-control" id="DeliveryNoticeNo_CreatedDateTime" name="DeliveryNoticeNo_CreatedDateTime" disabled>                         
                          </div>  
                          <div class="form-group">   
                            <label><h5>Customer Name</h5></label>                        
                            <textarea class="form-control" rows="3" placeholder="Customer_Name" id="Customer_Name" name="Customer_Name" disabled></textarea>                         
                          </div>      
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="id_so_dokumen" name="id_so_dokumen" disabled>
                          </div>
                          <div class="form-group">
  ...
  $('a[data-toggle="pill"]').on('shown.bs.tab',function(e){
    $($.fn.dataTable.tables(true)).DataTable()
        ...
        $('#example2').on('click','.btn_edit', function(e){
            e.preventDefault();
              var DeliveryNoticeNo = $(this).attr('id');
              var SalesOrderNo = $(this).attr('name');              
              $.ajax({
                url : "itv/administrator/submit_lnsw/issued_sales/issued_sales_controller.php",
                type : 'POST',
                data : {DeliveryNoticeNo_Edit : DeliveryNoticeNo, 
                ...
                success : function(response){
                  ...
                  $('#DeliveryNoticeNo').val(response[0].DeliveryNoticeNo);
                  $('#SalesOrderNo').val(response[0].SalesOrderNo);
                  $('#Werks').val(response[0].Werks);
                  $('#DeliveryNoticeNo_CreatedDateTime').val(response[0].DeliveryNoticeNo_CreatedDateTime['date']);
                  ...
                  $('#id_so_dokumen').val(response[1].id_so_dokumen);
        ...
        e.preventDefault();
        var flag_issue_type = $('#flag_issue_type').val();
        var id_trx_type_code = $('#id_trx_type_code').val();
        var npwp = $('#npwp').val();
        var nib = $('#nib').val();
        var DeliveryNoticeNo = $('#DeliveryNoticeNo').val();
        var SalesOrderNo = $('#SalesOrderNo').val();
        var Werks = $('#Werks').val();
        var DeliveryNoticeNo_CreatedDateTime = $('#DeliveryNoticeNo_CreatedDateTime').val();
        ...
        var id_so_dokumen = $('#id_so_dokumen').val();
        ...
        $.ajax({
          url : "itv/administrator/submit_lnsw/issued_sales/issued_sales_controller.php",
          type : 'POST',
          data : {DeliveryNoticeNo_Save : DeliveryNoticeNo,
                  flag_issue_type : flag_issue_type,
                  id_trx_type_code : id_trx_type_code,
                  npwp : npwp,
                  nib : nib, 
                  SalesOrderNo : SalesOrderNo,
                  Werks : Werks,
                  DeliveryNoticeNo_CreatedDateTime : DeliveryNoticeNo_CreatedDateTime,
          ...
          success : function(response){
            ...
            $('#npwp').val("");
            $('#nib').val("");
            $('#DeliveryNoticeNo').val("");
            $('#SalesOrderNo').val("");
            $('#Werks').val("");
            $('#DeliveryNoticeNo_CreatedDateTime').val("");
            $('#Customer_Name').val("");
