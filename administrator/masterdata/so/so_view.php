        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><a class='h10'>IT Inventory Active menu - <b>Master Data>Sales Order</b></a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                        ...
                                        <tr>     
                                            ...
                                            <td>                                              
                                                <a class="btn btn-default btn-sm" href="?page=so_edit&kode=<?php echo $data['SalesOrderNo']; ?>">
