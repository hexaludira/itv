...
//Menambahkan System baru
        if (isset ($_POST['SalesOrderNo'])){    
          ...
          $sql_simpan = "INSERT INTO itv_masterdata_so_dokumen (Werks,SalesOrderNo,id_doc_code,nomorDokumen,tanggalDokumen,createddatetime,createdby,isdelete)                                                                     
            VALUES (
                '$Werks',
                '$SalesOrderNo',
                '$id_doc_code',
