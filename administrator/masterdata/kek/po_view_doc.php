        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><a class='h10'>IT Inventory Active menu - <b>Master Data>KEK's Document PO</b></a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">KEK's Document PO Data</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                        ...
                                        <tr>     
                                            ...
                                            <td>                                              
                                                <a class="btn btn-default btn-sm" href="?page=po_add_document&kode=<?php echo $data['PurchaseNo']; ?>">
